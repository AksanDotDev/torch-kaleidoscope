...
__all__ = [
    "RGBToRGB", "RGBToXYZ", "RGBToYUV", "RGBToYIQ",
    "RGBToYCbCr", "RGBToYPbPr", "RGBToYDbDr", "RGBToRGBCIE",
    "RGBToHSV", "RGBToH2SV", "RGBToH3SV", "RGBToHED",
    "RGBToHDX", "RGBToFGX", "RGBToBEX", "RGBToRBD",
    "RGBToGDX", "RGBToHAX", "RGBToBRO", "RGBToBPX",
    "RGBToAHX", "RGBToHPX"
]
...
RGBToRGB = FixedIDConv

RGBToXYZ = FixedXYZConv

RGBToYUV = FixedYUVConv

RGBToYIQ = FixedYIQConv

RGBToYCbCr = FixedYCbCrConv

RGBToYPbPr = FixedYPbPrConv

RGBToYDbDr = FixedYDbDrConv

RGBToRGBCIE = FixedRGBCIEConv
...
RGBToHED = FixedLogHEDConv

RGBToHDX = FixedLogHDXConv

RGBToFGX = FixedLogFGXConv

RGBToBEX = FixedLogBEXConv

RGBToRBD = FixedLogRBDConv

RGBToGDX = FixedLogGDXConv

RGBToHAX = FixedLogHAXConv

RGBToBRO = FixedLogBROConv

RGBToBPX = FixedLogBPXConv

RGBToAHX = FixedLogAHXConv

RGBToHPX = FixedLogHPXConv
